...
SELECT * FROM SF_OB_city1 WHERE DRIVER_ID = '928182' 
;

SELECT FIRST_ORDER_DATE FROM production.denormalised.driver_accounting_daily WHERE DRIVER_ID = '928182' 
;
...
SELECT * FROM SF_ob_rider_cityonly WHERE COUNTRY_GROUP = 'UKI' AND approved_month = '2024-09-01' ORDER BY DRIVER_ID DESC
;

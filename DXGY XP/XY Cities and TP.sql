...
ORDER BY avg_throughput DESC, city_name DESC, date, peak
)
...
FROM CTE2 a
LEFT JOIN CTE b ON a.city_name = b.city_name AND a.date = b.date AND a.peak = b.peak
ORDER BY a.city_name, a.date DESC, a.peak DESC
